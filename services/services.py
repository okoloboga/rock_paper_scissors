...
async def game_result(result: str, my_id: str, enemy_id: str, room_id: str | int, msg_id: int):
    ...
    if result == 'lose':
        ...
        user[b'jettons'] = int(str(user[b'jettons'], encoding='utf-8')) - int(str(game[b'bet'], encoding='utf-8'))
        ...
        enemy[b'jettons'] = (int(str(enemy[b'jettons'], encoding='utf-8')) + int(str(game[b'bet'], encoding='utf-8')) +
                             int(str(enemy[b'referrals'], encoding='utf-8')))
        ...
        user[b'jettons'] = (int(str(user[b'jettons'], encoding='utf-8')) + int(str(game[b'bet'], encoding='utf-8')) +
                            int(str(user[b'referrals'], encoding='utf-8')))
...
# Timing starts
async def timer(bot: Bot, i18n: TranslatorRunner, room_id):
