...
@router.callback_query(F.data.in_(['rock', 'paper', 'scissors']), StateFilter(FSMMain.in_game))
...
@router.callback_query(F.data == 'end_game', StateFilter(FSMMain.in_game))
...
@router.message(CommandStart(), StateFilter(FSMMain.in_game))
